...
public class JtsWktShapeParserTest extends WktShapeParserTest {
  ...
  public void polyToRectCcwRule() throws ParseException {
    JtsSpatialContext ctx = new JtsSpatialContextFactory() { { datelineRule = JtsWKTFormat.DatelineRule.ccwRect;} }.newSpatialContext();
    //counter-clockwise
  ...
  public void testWrapTopologyException() {
    ...
    assert ((JtsWKTFormat)ctx.getWktShapeParser()).isAutoValidate();
    try {
  ...
  public void testPolygonRepair() throws ParseException {
    ...
    factory.validationRule = JtsWKTFormat.ValidationRule.repairBuffer0;
    ...
    factory.validationRule = JtsWKTFormat.ValidationRule.repairConvexHull;
    ...
    factory = new JtsSpatialContextFactory();
    factory.validationRule = JtsWKTFormat.ValidationRule.none;
    ctx = factory.newSpatialContext();

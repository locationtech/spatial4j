...
Spatial4j is well tested; continuous integration runs on [GitHub Actions](https://github.com/locationtech/spatial4j/actions) against Java 8, 11, 17, and 21, plus a [Jenkins build hosted by Eclipse](https://ci.eclipse.org/spatial4j/), and we use [Codecov](https://codecov.io/github/locationtech/spatial4j/) for code coverage.
...
Discuss Spatial4j on our [mailing list](https://accounts.eclipse.org/mailing-list/spatial4j-dev) ([archives](https://www.eclipse.org/lists/spatial4j-dev/); note: the pre-LocationTech list is [here](http://spatial4j.16575.n6.nabble.com/)).

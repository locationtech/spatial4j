...
Spatial4j began life within "Lucene Spatial Playground":http://code.google.com/p/lucene-spatial-playground/ (LSP) and from this work a generic core spatial library emerged, independent of Lucene. The other parts of LSP were either merged into Lucene / Solr itself or were migrated to "Spatial Solr Sandbox":https://github.com/ryantxu/spatial-solr-sandbox now.
...
/**
 * Extends {@link org.locationtech.spatial4j.io.WktShapeParser} adding support for polygons, using JTS.
 */
public class JtsWktShapeParser extends WktShapeParser {
  ...
  /**
   * Parses a POLYGON shape from the raw string. It might return a {@link org.locationtech.spatial4j.shape.Rectangle}
   ...
   * It's akin to {@link #point(org.locationtech.spatial4j.io.WktShapeParser.State)} but for

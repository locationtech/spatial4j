...
public class JtsWktShapeParserTest extends WktShapeParserTest {
  ...
  public void polyToRectCcwRule() throws ParseException {
    JtsSpatialContext ctx = new JtsSpatialContextFactory() { { datelineRule = WKTReaderJTS.DatelineRule.ccwRect;} }.newSpatialContext();
    //counter-clockwise
  ...
  public void testWrapTopologyException() {
    ...
    assert ((WKTReaderJTS)ctx.getWktShapeParser()).isAutoValidate();
    try {
  ...
  public void testPolygonRepair() throws ParseException {
    ...
    factory.validationRule = WKTReaderJTS.ValidationRule.repairBuffer0;
    ...
    factory.validationRule = WKTReaderJTS.ValidationRule.repairConvexHull;
    ...
    factory = new JtsSpatialContextFactory();
    factory.validationRule = WKTReaderJTS.ValidationRule.none;
    ctx = factory.newSpatialContext();

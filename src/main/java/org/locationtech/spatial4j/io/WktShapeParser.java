...
public class WktShapeParser {
   ...
   * {@link org.locationtech.spatial4j.io.WktShapeParser.State#nextIfEmptyAndSkipZM()}.
   *
   * @param state
   ...
   * {@link org.locationtech.spatial4j.context.SpatialContext#normX(double)} & normY.
   */
   ...
   * </pre>
   *
   * @see #parseLineStringShape(org.locationtech.spatial4j.io.WktShapeParser.State)
   */
   ...
   * calls {@link #parseShapeByType(org.locationtech.spatial4j.io.WktShapeParser.State, String)}
